      ...
      <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {categories.map((category) => {
          ...
          return (
            <article
              key={category.id}
              className="group relative flex flex-col overflow-hidden rounded-panel border border-line bg-surface-2 transition-[border-color,transform] duration-200 hover:-translate-y-0.5 hover:border-line-strong"
            >
              ...
              <div className="flex flex-1 flex-col p-5">
                ...
                <dl className="mt-auto flex items-center gap-4 pt-5 text-label text-soft">
