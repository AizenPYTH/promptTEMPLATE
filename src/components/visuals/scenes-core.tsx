...
/* The twelve original scenes: marketing, application and content surfaces. */
...
export function AnalyticsScene(props: SceneProps) {
  const { accent, rand } = props;
  return (
    <>
      <rect width={VIEW_W} height={VIEW_H} fill={SUBTLE} />
...
export function CommerceScene(props: SceneProps) {
  const { accent, rand } = props;
  return (
    <>
      <rect width={VIEW_W} height={VIEW_H} fill={SUBTLE} />
      ...
      {Array.from({ length: 6 }, (_, i) => {
        ...
        return (
          <g key={i}>
            ...
            <rect x={x + 62} y={y + 30} width={188} height={104} rx={6} fill={LINE_STRONG} opacity={0.46} />
            <rect x={x + 62} y={y + 104} width={92} height={30} rx={4} fill={SURFACE} opacity={0.2} />
...
export function PortfolioScene(props: SceneProps) {
  const { accent, rand } = props;
  return (
    <>
      ...
      <rect x={80} y={340} width={480} height={330} rx={4} fill={DEEP} stroke={LINE} strokeWidth={2} />
      <rect x={140} y={396} width={360} height={218} rx={4} fill={LINE_STRONG} opacity={0.46} />
      <rect x={140} y={560} width={180} height={54} rx={4} fill={SURFACE} opacity={0.2} />
      <rect x={600} y={132} width={520} height={256} rx={4} fill={DEEP} stroke={LINE} strokeWidth={2} />
      <rect x={648} y={172} width={424} height={176} rx={4} fill={LINE_STRONG} opacity={0.44} />
      <rect x={600} y={414} width={250} height={256} rx={4} fill={DEEP} stroke={LINE} strokeWidth={2} />
      <rect x={632} y={450} width={186} height={150} rx={4} fill={LINE_STRONG} opacity={0.4} />
      <rect x={870} y={414} width={250} height={256} rx={4} fill={DEEP} stroke={LINE} strokeWidth={2} />
      <rect x={902} y={450} width={186} height={150} rx={4} fill={LINE_STRONG} opacity={0.5} />
...
export function EditorialScene(props: SceneProps) {
  const { accent, rand } = props;
  return (
    <>
      <rect width={VIEW_W} height={VIEW_H} fill={SURFACE} />
      ...
      <rect x={610} y={512} width={510} height={192} rx={4} fill={DEEP} stroke={LINE} strokeWidth={2} />
      <rect x={648} y={544} width={434} height={128} rx={4} fill={LINE_STRONG} opacity={0.46} />
      <Bar x={80} y={556} w={200} h={9} fill={accent} opacity={0.7} />
    </>
  );
}

export function MobileScene(props: SceneProps) {
  const { accent, rand } = props;
  const px = 452;
  const py = 40;
  const pw = 296;
...
export function DocsScene(props: SceneProps) {
  const { accent, rand } = props;
  return (
    <>
      <rect width={VIEW_W} height={VIEW_H} fill={SURFACE} />
...
export function PricingScene(props: SceneProps) {
  const { accent, rand } = props;
  return (
    <>
      <rect width={VIEW_W} height={VIEW_H} fill={SUBTLE} />
...
export function AuthScene(props: SceneProps) {
  const { accent, rand } = props;
  return (
    <>
      <rect width={VIEW_W} height={VIEW_H} fill={SUBTLE} />
...
export function SettingsScene(props: SceneProps) {
  const { accent, rand } = props;
  return (
    <>
      <rect width={VIEW_W} height={VIEW_H} fill={SUBTLE} />
